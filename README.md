...
The messages generated by this project are intended for use in a Unity3D project with [ROSBridgeLib](https://github.com/noirb/ROSBridgeLib/). This results in a few assumptions by the generator which may cause you problems if you want to use the generated classes without ROSBridgeLib or outside of a Unity project.
